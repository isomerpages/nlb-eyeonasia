...
[**Artificial Intelligence White Paper 2022**](https://cset.georgetown.edu/wp-content/uploads/t0442_AI_white_paper_2022_EN.pdf){:target="_blank"}

This report by China Academy of Information and Communications Technology
(CAICT) in April 2022 describes the state of artificial intelligence in China and the world. It provides an overview of AI development and the shift in government focus towards AI governance, safety and trustworthiness. It also focuses on the development of AI in relation with China's 14th Five-Year-Plan.
